...
public class ImageDiskLruCache {
     ...
     * {@link ImageDiskLruCache#openCache(Context, File, long)} which runs some extra
     ...
     * be called directly, call {@link ImageDiskLruCache#clearCache(Context, String)}
     * or {@link ImageDiskLruCache#clearCache()} instead.
     * 
     * @param cacheDir
     ...
     * {@link ImageDiskLruCache#setCompressParams(CompressFormat, int)} first to set
